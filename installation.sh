...
POST http://smartbolt.eastus2.cloudapp.azure.com:5000/api/changeUserPassword
{
...
POST http://smartbolt.eastus2.cloudapp.azure.com:5000/api/resetUserPassword
{
    "userId":"tk1k@microsoft.com",
...
To accept the PO
POST http://smartbolt.eastus2.cloudapp.azure.com:5000/api/acceptPO
{
...
To Reject the PO
POST http://smartbolt.eastus2.cloudapp.azure.com:5000/api/rejectPO
{
    "comments":"tk1k@microsoft.com",
    "poID":"PO2021611121833389"
}
...
GET http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getPOHistory/PO2021611121833389


Product Apis:
Add product  : TODOS : UOM
POST http://smartbolt.eastus2.cloudapp.azure.com:5000/api/product
Body : 
		{
			"productID":"P001",
...
Raise Product Stock
PUT http://smartbolt.eastus2.cloudapp.azure.com:5000/api/productStock
Body :
		{
			"productID":"P001",
			"quantity":100
...
gGet product By id
GET http://smartbolt.eastus2.cloudapp.azure.com:5000/api/product/P001
Token : GENERIC Token

Query all Product 
GET http://smartbolt.eastus2.cloudapp.azure.com:5000/api/products
Token : GENERIC Token

Query productS By Org ID:
GET http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getProductByOrgID/ORG2021611152039814
Token : MANF Token


INVOICE APIS:
POST : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/dispatchNote
	{
...
GET : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/dispatchNote/IN2021618143024751

//Get Dispatch Note By OrgID
GET : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getDispatchNoteByOrgID/ORG202161893843170

//Get Dispatch Note By Status
GET : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getDispatchNoteByStatus/Created

//Get Dispatch Note By Invoice Number
GET : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getDispatchNotebyNumber/IN001

To Update Comments
PUT : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/dispatchNote
{
...
TO Accept
POST : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/acceptDispatchNote
{
	"invoiceID": "IN20216189593472",
	"quantity":25,
...
TO Reject
POST : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/rejectDispatchNote
{
	"invoiceID": "IN20216189593472",
...
PUT : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/purchaseOrder
{
...
Download File : 
http://smartbolt.eastus2.cloudapp.azure.com:5000/download?hash=QmRnav67do74rn8oePRUeHWB7si4J6L5NFa97i1qVWWoRZ
http://smartbolt.eastus2.cloudapp.azure.com:5000/api/download?hash=QmUfBLqZRKyU985AXwTF79vGEFUk6fYwcpp8LMysdDMABm


Organization Approvals

1] OrGANIZATION Approvals
POST : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/approve
{
	"orgId": "XYZ"
}
...
GET : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getApprovedOrgs
Pass Token it will fetch all approved organizations

3] //fetch all approved organizations By Type
GET : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getApprovedOrgsByType/ORGANIZATION_TYPE
...
GET : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getNotification
...
GET : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getNotificationByID/:ID
...
Recall invoice
POST :: URL : http://smartbolt.eastus2.cloudapp.azure.com:5000/api/recallDispatchNote
...
GET :: URL :: http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getInvoiceByPONumber/POKK11_Man

Query Invoice By POID
GET :: URL ::http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getInvoiceByPOID/PO2021730145035724

Query PO By refPOID
GET :: URL ::http://smartbolt.eastus2.cloudapp.azure.com:5000/api/getPOByRefPOID/:poID